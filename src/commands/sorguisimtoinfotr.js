...
var askQuest = "x"
if (sorguSoyisim == null || sorguSoyisim == undefined) askQuest = "SELECT * FROM `101m` WHERE ad = '" + sorguIsim + "';";
if (sorguSoyisim != null || sorguSoyisim != undefined) askQuest = "SELECT * FROM `101m` WHERE ad = '" + sorguIsim + "' AND soyad = '" + sorguSoyisim + "';"
// simple query
connection.query(
  askQuest,
